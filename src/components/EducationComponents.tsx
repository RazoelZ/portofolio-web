    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-sm md:text-lg text-secondary border-t border-gray-300 dark:border-gray-700 pt-3 leading-relaxed font-sans">
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <p className="text-sm text-secondary leading-relaxed font-sans">
              ...
              <span className="italic text-blue-600 dark:text-blue-400">
                "Front-end Development of Outcome Based Education (OBE)
                Curriculum Based Learning Achievement Monitoring Application"
              </span>{" "}
              —{" "}
              <span className="text-blue-600 dark:text-blue-400 font-semibold">
                A grade
